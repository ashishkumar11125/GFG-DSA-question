...
{
public:
    map<int, int> mp; // Map to store island ID and size.
    ...
    // Depth-First Search to label an island and count its size.
    ...
    {
        int name = 2; // Initialize the island label.
        int n = grid.size();
        bool **vis = new bool*[n];
        for(int i = 0; i < n; i++)
        {
        ...
        // Label and count the size of each island.
        for(int i = 0; i < n; i++)
        {
            for(int j = 0; j < n; j++)
            {
        ...
        // Iterate through the grid to find the largest island.
        for(int i = 0; i < n; i++)
        {
            for(int j = 0; j < n; j++)
            {
                ...
                if(grid[i][j] == 0)
                {
                    set<int> st; // Set to keep track of neighboring islands.
