...
public:
    ...
    // Function to insert a new node with given data into the AVL tree and maintain balance.
    ...
    // Function to perform an in-order traversal of the AVL tree and print node values.
