...
public:
    ...
    bool symmetric(struct Node* root1, struct Node* root2) 
    {
        ...
        // If the data of the nodes is not equal, they are not symmetric
        if (root1->data != root2->data)
            return false;

        // Recursively check if the left subtree of the first node is symmetric
        // with the right subtree of the second node, and vice versa
