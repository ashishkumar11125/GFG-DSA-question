<h2><a href="https://practice.geeksforgeeks.org/problems/selection-sort/1?page=1&difficulty[]=0&category[]=Sorting&sortBy=submissions">Selection Sort</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an unsorted array of size N, use selection sort to sort arr[] in increasing order.</span></p>
