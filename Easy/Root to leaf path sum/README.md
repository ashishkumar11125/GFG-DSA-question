<h2><a href="https://www.geeksforgeeks.org/problems/root-to-leaf-path-sum/1?page=1&company=Atlassian&sortBy=submissions">Root to leaf path sum</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a binary tree and an integer s, check whether there is a root-to-leaf path with its sum as s.</span></p>
