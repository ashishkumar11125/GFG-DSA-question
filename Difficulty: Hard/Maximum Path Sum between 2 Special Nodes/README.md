<h2><a href="https://www.geeksforgeeks.org/problems/maximum-path-sum/1?page=1&company=Amazon,Microsoft,Adobe,Google&difficulty=Hard&sortBy=submissions">Maximum Path Sum between 2 Special Nodes</a></h2><h3>Difficulty Level : Difficulty: Hard</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a binary tree in which each node element contains a number. Find the maximum possible path sum from one special node to another special node.</span></p>
